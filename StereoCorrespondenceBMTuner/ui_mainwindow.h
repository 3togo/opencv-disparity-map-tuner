...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalSlider_pre_filter_size->setObjectName(QString::fromUtf8("horizontalSlider_pre_filter_size"));
        ...
        label_pre_filter_size->setObjectName(QString::fromUtf8("label_pre_filter_size"));
        ...
        horizontalSlider_texture_threshold->setObjectName(QString::fromUtf8("horizontalSlider_texture_threshold"));
        ...
        label_texture_threshold->setObjectName(QString::fromUtf8("label_texture_threshold"));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "OpenCV StereoCorrespondenceBM Tuner", nullptr));
        label_6->setText(QApplication::translate("MainWindow", "10", nullptr));
        label->setText(QApplication::translate("MainWindow", "41", nullptr));
        label_pre_filter_size->setText(QApplication::translate("MainWindow", "Pre-filter size", nullptr));
#ifndef QT_NO_TOOLTIP
        label_min_disparity->setToolTip(QApplication::translate("MainWindow", "<html><head/><body><p>Minimum possible disparity value. Normally, it is zero but sometimes rectification algorithms can shift images, so this parameter needs to be adjusted accordingly.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        label_min_disparity->setText(QApplication::translate("MainWindow", "Minimum disparity", nullptr));
#ifndef QT_NO_TOOLTIP
        label_num_of_disparity->setToolTip(QApplication::translate("MainWindow", "<html><head/><body><p>Maximum disparity minus minimum disparity. The value is always greater than zero. In the current implementation, this parameter must be divisible by 16.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        label_num_of_disparity->setText(QApplication::translate("MainWindow", "Number of disparity", nullptr));
        label_8->setText(QApplication::translate("MainWindow", "0", nullptr));
        label_3->setText(QApplication::translate("MainWindow", "41", nullptr));
#ifndef QT_NO_TOOLTIP
        label_SAD_window_size->setToolTip(QApplication::translate("MainWindow", "<html><head/><body><p>Matched block size. It must be an odd number <span style=\" font-family:'Courier New,courier';\">&gt;=1</span> . Normally, it should be somewhere in the <span style=\" font-family:'Courier New,courier';\">3..11</span> range.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        label_SAD_window_size->setText(QApplication::translate("MainWindow", "SAD window size", nullptr));
        label_9->setText(QApplication::translate("MainWindow", "0", nullptr));
        label_2->setText(QApplication::translate("MainWindow", "31", nullptr));
        label_5->setText(QApplication::translate("MainWindow", "128", nullptr));
#ifndef QT_NO_TOOLTIP
        label_uniqueness_ratio->setToolTip(QApplication::translate("MainWindow", "<html><head/><body><p>Margin in percentage by which the best (minimum) computed cost function value should \342\200\234win\342\200\235 the second best value to consider the found match correct. Normally, a value within the 5-15 range is good enough.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        label_uniqueness_ratio->setText(QApplication::translate("MainWindow", "Uniqueness ratio", nullptr));
        pushButton_right->setText(QApplication::translate("MainWindow", "Load right image", nullptr));
        pushButton_left->setText(QApplication::translate("MainWindow", "Load left image", nullptr));
#ifndef QT_NO_TOOLTIP
        label_speckle_window_size->setToolTip(QApplication::translate("MainWindow", "<html><head/><body><p>Maximum size of smooth disparity regions to consider their noise speckles and invalidate. Set it to 0 to disable speckle filtering. Otherwise, set it somewhere in the 50-200 range.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        label_speckle_window_size->setText(QApplication::translate("MainWindow", "Speckle window size", nullptr));
#ifndef QT_NO_TOOLTIP
        label_pre_filter_cap->setToolTip(QApplication::translate("MainWindow", "<html><head/><body><p>Truncation value for the prefiltered image pixels. The algorithm first computes x-derivative at each pixel and clips its value by <span style=\" font-family:'Courier New,courier';\">[-preFilterCap, preFilterCap]</span> interval. The result values are passed to the Birchfield-Tomasi pixel cost function.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        label_pre_filter_cap->setText(QApplication::translate("MainWindow", "Pre-filter cap", nullptr));
#ifndef QT_NO_TOOLTIP
        label_speckle_range->setToolTip(QApplication::translate("MainWindow", "<html><head/><body><p>Maximum disparity variation within each connected component. If you do speckle filtering, set the parameter to a positive value, it will be implicitly multiplied by 16. Normally, 1 or 2 is good enough.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        label_speckle_range->setText(QApplication::translate("MainWindow", "Speckle range", nullptr));
        label_4->setText(QApplication::translate("MainWindow", "-64", nullptr));
        label_7->setText(QApplication::translate("MainWindow", "15", nullptr));
        label_texture_threshold->setText(QApplication::translate("MainWindow", "Texture threshold", nullptr));
#ifndef QT_NO_TOOLTIP
        label_disp_12_max_diff->setToolTip(QApplication::translate("MainWindow", "<html><head/><body><p>Maximum allowed difference (in integer pixel units) in the left-right disparity check. Set it to a non-positive value to disable the check.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        label_disp_12_max_diff->setText(QApplication::translate("MainWindow", "Disp. 12 max. diff.", nullptr));
        label_10->setText(QApplication::translate("MainWindow", "-1", nullptr));
        label_depth_map->setText(QApplication::translate("MainWindow", "Depth map", nullptr));
        label_image_right->setText(QApplication::translate("MainWindow", "Right image", nullptr));
        label_image_left->setText(QApplication::translate("MainWindow", "Left image", nullptr));
    } // retranslateUi
